...
const LandingPage: React.FC<LandingPageProps> = ({ onStart, language }) => (
  <div className="flex flex-col items-center justify-center min-h-[75vh] text-center px-4 sm:px-6 animate-fade-in max-w-2xl mx-auto">
    ...
    <div className="grid grid-cols-3 gap-3 sm:gap-6 w-full">
      <FeatureCard icon={Upload} text={t(language, 'step1Title')} />
      <FeatureCard icon={Heart} text={t(language, 'step2Title')} />
      <FeatureCard icon={CheckCircle} text={t(language, 'step3Title')} />
    </div>
